...
public class ByteDanceAudioApi {
	 ...
	 */
	public ByteDanceAudioApi(String openAiToken) {
		this(ByteDanceApiConstants.DEFAULT_BASE_URL, openAiToken, RestClient.builder(), WebClient.builder(),
	 ...
	 */
	public ByteDanceAudioApi(String baseUrl, String openAiToken, RestClient.Builder restClientBuilder,
