...
/**
 * {@link RateLimit} implementation for {@literal ByteDance}.
 *
 * @author yang
 * @see <a href=
 ...
 * limits in headers</a>
 */
public class ByteDanceRateLimit implements RateLimit {
	...
	public ByteDanceRateLimit(Long requestsLimit, Long requestsRemaining, Duration requestsReset, Long tokensLimit,
