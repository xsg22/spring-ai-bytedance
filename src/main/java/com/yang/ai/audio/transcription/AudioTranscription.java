 ...
 */
package com.yang.ai.audio.transcription;

import com.yang.ai.metadata.audio.ByteDanceAudioTranscriptionMetadata;
...
public class AudioTranscription implements ModelResult<String> {
	...
	private ByteDanceAudioTranscriptionMetadata transcriptionMetadata;
	...
	@Override
	public ByteDanceAudioTranscriptionMetadata getMetadata() {
		return transcriptionMetadata != null ? transcriptionMetadata : ByteDanceAudioTranscriptionMetadata.NULL;
	}

	public AudioTranscription withTranscriptionMetadata(
			@Nullable ByteDanceAudioTranscriptionMetadata transcriptionMetadata) {
