...
public class AudioTranscriptionResponse implements ModelResponse<AudioTranscription> {
	...
	private ByteDanceAudioTranscriptionResponseMetadata transcriptionResponseMetadata;

	public AudioTranscriptionResponse(AudioTranscription transcript) {
		this(transcript, ByteDanceAudioTranscriptionResponseMetadata.NULL);
	}

	public AudioTranscriptionResponse(AudioTranscription transcript,
			ByteDanceAudioTranscriptionResponseMetadata transcriptionResponseMetadata) {
	...
	@Override
	public ByteDanceAudioTranscriptionResponseMetadata getMetadata() {
